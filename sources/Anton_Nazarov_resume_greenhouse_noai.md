...
Technology leader and systems architect with 18 years across IT leadership, infrastructure, internal systems, automation, and software delivery. Experience spans CTO-style delivery, ERP/CRM and portal builds, and hybrid systems using IBM Domino, low-code platforms, PostgreSQL, and API integrations. 
...
Selected projects: PromptlessPress, MetaFox Strengths Explorer, Exit Lead, Andronyevskaya ERP, Vencer Autismo, Educate Online, QR Cloud, Dobri Visarun, Dobri Tours, Cashdesk Accounting, Serbia Networking App, RuskaJela.
...
- Partnered with IT directors and heads of IT across 100+ subordinate cultural institutions to rebuild a legacy IBM Domino data-collection system into a web-based information system with modular architecture.
...
- Replaced a 5-hour, single-user export workflow with web-based report generation that usually completed in 1.5 seconds to 1.5 minutes for authorized users across institutions.
...
- Created practical rules for access control and system modifications, because informal changes had become a real operational risk.
...
- Reorganized the IT department, documentation, responsibilities, request handling, and internal service discipline, including who owned which recurring issues.
...
## Skills
Architecture, Infrastructure, Automation, Databases, Low-Code Platforms, APIs/Integrations, ITSM, and Leadership. Include the most target-relevant terms already present in the CV: IBM Domino, XPages, nginx, PostgreSQL, Supabase, Docker, Active Directory, GLPI, Zabbix, n8n, Make, Bubble, WeWeb, API integrations, and ERP/CRM.