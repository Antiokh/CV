# I.T. Information Technology — canonical employer dossier

**Employer:** I.T. Information Technology / systems-integration environment  
**Role:** Lotus Notes Specialist  
**Dates:** Jan 2011 – Apr 2012  
**Status:** primary source for future CV tailoring about this employer.

## Core evidence

- Developed and maintained IBM Domino / Lotus Notes workflow systems.
- Introduced **XPages** into the company / working environment.
- Reworked the core Boss-Referent library / workflow components in JavaScript / SSJS to support web interfaces.
...
- legacy-to-web modernization;
- enterprise document/workflow systems;
- reusable platform / library work rather than only one-off forms;
- internal knowledge transfer / training;
- practical IBM Domino depth before the later bank / Directorate ownership roles.

## Strongest use by role

- Solutions Architect / Engineering: technical foundation in enterprise workflow modernization.
- CTO / EM: supporting evidence of long technical depth and mentoring.
- Product / Delivery: normally compress unless legacy modernization is relevant.

## Claims to avoid or qualify

- Do not merge this employer's technical achievements with Beluga Group without checking attribution.
- No strong current evidence for team size, budget or business outcome metrics here.
