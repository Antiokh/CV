...
Do not copy operational tracker/salary/CV-artifact mechanics into this bootstrap. The runtime routes to the current canonical contracts. `tracker-storage-v4.md` and `workinterviews-simple-onedit.gs` are deprecated tombstones.
